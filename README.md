...
- [Bayesian Spectacles](https://www.bayesianspectacles.org/)
    ...
    - Recent Post: [Redefine Statistical Significance XX: A Chat on P-values with ChatGPT](https://www.bayesianspectacles.org/redefine-statistical-significance-xx-a-chat-on-p-values-with-chatgpt/) (February 8, 2023)
...
- [Learning Bayesian Statistics](https://www.learnbayesstats.com/)
    ...
    - Recent Episode: [#71 Artificial Intelligence, Deepmind & Social Change, with Julien Cornebise](https://learnbayesstats.com/episode/71-artificial-intelligence-deepmind-social-change-julien-cornebise/) (November 14, 2022)
